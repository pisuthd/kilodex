                ...
                >
                    ...
                    >
                        <span className="bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent">
                            Can Institutions Access DeFi Without
                        </span>
                    ...
                    >
                        Until now, providing liquidity meant revealing trading patterns and positions, creating competitive and regulatory risks.
                        <span className="text-green-400 font-semibold">{' '}KiloDEX{' '}</span>
                        enables institutional liquidity with privacy and controlled participation.
                    </motion.p>
                </motion.div>
            </div>
        </section>
